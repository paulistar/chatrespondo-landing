...
| **S5 — UI canal + history sync** | 3 | Card com reconectar/reescanear/logout; ícone; **import de histórico ao conectar (confirmado)** | ✅ **DONE (2026-07-20)** api `b74ddfb` · web `a966531` · landing docs `06f93e4` — `EvolutionSyncAdapter` (findChats/findMessages), auto-import em `CONNECTION_UPDATE open`, botão **Importar histórico**, lookback `EVOLUTION_HISTORY_LOOKBACK_DAYS` (default 30, max 90) |
